...
<body>
    ...
    <header class="topbar">
        ...
        <div class="top-right">
            <div class="year-pill"><span class="dot"></span><?= $anneeScolaire["libelle"] ?></div>
            ...
            <div class="user">
                ...
                <div class="user-meta">
                    <div class="user-name"><?= $userConnected["nom"] ?></div>
                    <div class="user-role"><?= $userConnected["libelle"] ?></div>
                </div>
            ...
            <a href="http://localhost:8000/logout" class="btn btn-primary" id="saveBtn" style="text-decoration : none;">
                Deconnexion
            </a>
        </div>
    </header>
    ...
    <div class="page">
        ...
        <div class="hero">
            ...
            <div class="hero-actions">
                ...
                <button form="monFormulaire" type="submit" class="btn btn-primary" id="saveBtn">
        ...
        <form action="http://localhost:8000" method="POST" class="filters-card" id="filtersCard">
            <div class="field">
                <label for="classe">Classe</label>
                <div class="select-wrap">
                    <select name="classe">
                        <option value="0">Veuillew selectionner une classe</option>
            ...
            <div class="stat">
                ...
                <div class="stat-value" id="classAvg"><?= $moyen ?><span>/20</span></div>
            </div>
        </form>
...
<!-- 
    <script>
        ...
        data - field = "d2"
        data - idx = "${i}" > < /td> <
            td > < input class = "grade-input comp"
        type = "number"
        min = "0"
        max = "20"
        step = "0.5"
        ...
        data - field = "comp"
        data - idx = "${i}" > < /td> <
            td > < span class = "moyenne-val"
        data - moy = "${i}" > < /span></td >
            <
            td > < span class = "pill"
        data - app = "${i}" > < span class = "pdot" > < /span><span class="app-label"></span > < /span></td >
            `;
